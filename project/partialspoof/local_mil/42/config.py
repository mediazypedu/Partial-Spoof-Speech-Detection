...
input_dirs = [tmp + '/train_dev/con_wav']
...
#optional_argument = [tmp + '/protocols/PartialSpoof_LA_cm_protocols/PartialSpoof.LA.cm.train.trl.txt']
optional_argument = [tmp + '/segment_labels/train_dev_eval_seglab_0.16.npy']
#optional_argument = [tmp + '/segment_labels/eval_seglab_0.16.npy']
#########################################################
## Configuration for inference stage
#########################################################
# similar options to training stage

test_set_name = 'dev'  #'eval' 'dev'

# List of test set data
# for convenience, you may directly load test_set list here
test_list = tmp + '/scp/dev.lst' #'/scp/eval.lst'#'/scp/dev.lst'

# Directories for input features
# input_dirs = [path_of_feature_1, path_of_feature_2, ..., ]
#  we assume train and validation data are put in the same sub-directory
test_input_dirs = [tmp + '/dev/con_wav'] #[tmp + '/eval/con_wav'] #[tmp + '/dev/con_wav']

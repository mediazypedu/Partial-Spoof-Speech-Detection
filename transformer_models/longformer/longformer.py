...
from transformer_models.longformer.diagonaled_mm_tvm import diagonaled_mm as diagonaled_mm_tvm, mask_invalid_locations
from transformer_models.longformer.sliding_chunks import sliding_chunks_matmul_qk, sliding_chunks_matmul_pv
from transformer_models.longformer.sliding_chunks import sliding_chunks_no_overlap_matmul_qk, sliding_chunks_no_overlap_matmul_pv
...
class LongformerSelfAttention(nn.Module):
    ...
    def forward(
        ...
        #return outputs
        return context_layer, attn_weights if output_attentions else context_layer, None

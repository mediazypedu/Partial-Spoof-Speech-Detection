...
def parse_txt_utt(file_path):
    bonafide = []
    spoofed = []
    protocol = '/data/git_repository/research/ASVSpoof/partialspoof/dataset/ASVSpoof2019' \
                   +'/labels/cm_label_train_dev_eval.txt'
    data_buffer = {}
    temp_buffer = np.loadtxt(protocol, dtype='str')
...
#cm_scores_file =  './cm_scores/dev_score_mil_2019.txt'
#cm_scores_file =  './cm_scores/eval_score_mil_2019.txt'
#cm_scores_file =  './cm_scores/dev_score_local_mil_2019.txt'
#cm_scores_file =  './cm_scores/eval_score_local_mil_2019.txt'
#cm_scores_file =  './cm_scores/dev_score_mil_partialto2019.txt'
#cm_scores_file =  './cm_scores/eval_score_mil_partialto2019.txt'
#cm_scores_file =  './cm_scores/dev_score_local_mil_partialto2019.txt'
cm_scores_file =  './cm_scores/eval_score_local_mil_partialto2019.txt'
# Replace ASV scores with organizers' scores or provide score file as the second argument.
#asv_score_file = './ASV_scores/ASVspoof2019_LA_asv_scores/ASVspoof2019.LA.asv.dev.gi.trl.scores.txt'
asv_score_file = './ASV_scores/ASVspoof2019_LA_asv_scores/ASVspoof2019.LA.asv.eval.gi.trl.scores.txt'

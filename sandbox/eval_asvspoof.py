    ...
    if tar_asv_scores is None or non_asv_scores is None or \
       spoof_asv_scores is None:
        file_name = os.path.dirname(__file__)+ \
            '/data/partialspoof/PartialSpoof_LA_asv_scores/PartialSpoof.LA.asv.eval.gi.trl.scores.bin'
            #'/data/partialspoof/PartialSpoof_LA_asv_scores/PartialSpoof.LA.asv.dev.gi.trl.scores.bin'
